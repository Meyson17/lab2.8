...
<p align= "right">Выполнил: Рыжков В.Э. </p><br><br><br><br><br><br><br><br>
...
“и господа”. Вывести значения переменных в браузер. Сформировать строку "Доброе утро, дамы и господа" используя созданные переменные и  комбинированный оператор склеивания. <br>
...
async function sendEmail() {
  ...
  let transporter = nodemailer.createTransport({
    ...
    secure: false,
    auth: {
      user: 'meyson172@yandex.ru',
      pass: 'oiisswsxcpnyxtrq'
    }
  });

  
  let mailOptions = {
    from: 'meyson172@yandex.ru',
    to: '2003vova19@gmail.com',
    subject: 'Hello ',
    text: 'World!!',
  };
